...
public class CarsAssemble {
    ...
    public double productionRatePerHour(int speed) {
        if(speed == 0) { return 0; }
        if(speed >= 10){
            return this.productionCalculator(speed, carsPerHour, .77);
        } else if(speed == 9){
            return this.productionCalculator(speed, carsPerHour, .8);
        } else if(speed >= 5){
            return this.productionCalculator(speed, carsPerHour, .9);
        }
    ...
    private double productionCalculator(int speed, int carsPerHour, double percentage) {
        return speed * carsPerHour * percentage;
    }
}